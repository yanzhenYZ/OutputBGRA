...
#import "TYUVCapture.h"
#import <AVFoundation/AVFoundation.h>

@interface TYUVCapture ()<AVCaptureVideoDataOutputSampleBufferDelegate>
...
- (void)configSession {
    ...
    //ios 只支持三中视频格式
    NSLog(@"___%@:%d:%d:%d", _dataOutput.availableVideoCVPixelFormatTypes, kCVPixelFormatType_420YpCbCr8BiPlanarFullRange, kCVPixelFormatType_420YpCbCr8BiPlanarVideoRange, kCVPixelFormatType_32BGRA);
